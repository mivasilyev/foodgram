# Generated by Django 3.2.16 on 2025-04-24 06:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_favorited', models.ManyToManyField(blank=True, related_name='is_favorited', through='recipes.Favorite', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'verbose_name': 'рецепт',
